...
class RealDebridAPI:
	def __init__(self):
		self.client_ID = get_setting('vibestream.rd.client_id', 'empty_setting')
		if self.client_ID in ('empty_setting', ''): self.client_ID = 'X245A4XAIBGVM'
		self.token = get_setting('vibestream.rd.token', 'empty_setting')
		self.secret = get_setting('vibestream.rd.secret', 'empty_setting')
		self.refresh = get_setting('vibestream.rd.refresh', 'empty_setting')
		self.device_code = ''
