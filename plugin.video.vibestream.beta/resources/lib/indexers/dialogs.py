...
def enable_scrapers_choice(params={}):
	icon = params.get('icon', None) or get_icon('vibestream')
...
def scraper_color_choice(params):
	...
	current_setting, original_highlight = get_setting('vibestream.%s' % setting), default_setting_values(setting)['setting_default']
